...
/*
 *Eigen::Matrix2d lineProjectionTdFactor::line_sqrt_info;
lineProjectionTdFactor::lineProjectionTdFactor(const Eigen::Vector3d& _start_i, const Eigen::Vector3d& _end_i,
    const Eigen::Vector3d& _start_j, const Eigen::Vector3d& _end_j, const Eigen::Vector2d& _velocity_i, const Eigen::Vector2d& _velocity_j,
    const double _td_i, const double _td_j, const double _row_i, const double _row_j)
: start_i(_start_i), end_i(_end_i), start_j(_start_j), end_j(_end_j), td_i(_td_i), td_j(_td_j)
{
    velocity_i.x() = _velocity_i.x();
    velocity_i.y() = _velocity_i.y();
    velocity_i.z() = 0;
...
bool lineProjectionTdFactor::Evaluate(double const *const *parameters, double *residuals, double **jacobians)const
{
    Eigen::Vector3d Pi(parameters[0][0], parameters[0][1], parameters[0][2]);
    Eigen::Quaterniond Qi(parameters[0][6], parameters[0][3], parameters[0][4], parameters[0][5]);
